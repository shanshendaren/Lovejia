//
//  MyCommentThingsListViewController.m
//  PropertyManagement
//
...
@interface MyCommentThingsListViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation MyCommentThingsListViewController
...
- (void)headerRereshing
{
    ...
    NSString *sid = @"QueryPageParticipateInBarterInfoListByself";
    ...
    if ([json[@"status"]isEqualToString:@"success"]) {
        if ([json[@"isComplete"]isEqualToString:@"yes"]) {
            ...
            for (int i = 0; i <arr.count ; i++) {
                ...
                barter.barterCommentContent = [NSString stringWithFormat:@"%@",rdic[@"barterCommentContent"]];
                barter.isAgree = [NSString stringWithFormat:@"%@",rdic[@"isAgree"]];
