...
@interface BZSheQuListViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation BZSheQuListViewController
...
-(void)pushAction{
    BZSheQuSetViewController *svc =[[BZSheQuSetViewController alloc]init];
