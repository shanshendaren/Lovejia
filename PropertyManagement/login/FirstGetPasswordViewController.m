...
-(void)createUI{
    ...
    [infoL setFont:[UIFont fontWithName:@"Arial" size:FONT_SIZE]];
    ...
    nextBtn.tag = 1;
    [nextBtn setFrame:CGRectMake(15, 250, self.view.frame.size.width-30, 35)];
    nextBtn.titleLabel.font = [UIFont fontWithName:@"Arial" size:FONT_SIZE];
