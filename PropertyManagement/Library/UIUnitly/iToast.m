...
@property (nonatomic, retain) iToastSettings  *_settings;
	...
	switch (orientation) {
		case UIDeviceOrientationPortrait:
		{
			if (theSettings.gravity == iToastGravityTop) {
				point = CGPointMake(window.frame.size.width / 2, window.frame.size.height / 4);
			}
            else if (theSettings.gravity == iToastGravityBottom) {
				point = CGPointMake(window.frame.size.width / 2, window.frame.size.height * 3 / 4);
			}
		...
		case UIDeviceOrientationPortraitUpsideDown:
		{
			...
			if (theSettings.gravity == iToastGravityTop) {
				point = CGPointMake(width / 2, height * 3 / 4);
			}
            else if (theSettings.gravity == iToastGravityBottom) {
				point = CGPointMake(width / 2, height / 4);
			}
            else if (theSettings.gravity == iToastGravityCenter) {
		...
		case UIDeviceOrientationLandscapeLeft:
		{
			...
			if (theSettings.gravity == iToastGravityTop) {
				point = CGPointMake(window.frame.size.width * 3 / 4, window.frame.size.height / 2);
			}
            else if (theSettings.gravity == iToastGravityBottom) {
				point = CGPointMake(window.frame.size.width / 4,window.frame.size.height / 2);
			}
            else if (theSettings.gravity == iToastGravityCenter) {
				point = CGPointMake(window.frame.size.width/2, window.frame.size.height/2);
			}
...
#pragma mark -- implementation iToastSettings
